				...
				<Drawer.TemporaryDrawer ref={drawer => { this.drawer = drawer; }} >
					...
					<Drawer.TemporaryDrawerContent>
						<List>
							...
							<List.LinkItem onClick={() => { route('/skills'); this.closeDrawer(); }}>
								<List.ItemIcon>build</List.ItemIcon>
								Skills
							</List.LinkItem>
							<List.LinkItem onClick={() => { route('/experience'); this.closeDrawer(); }}>
								<List.ItemIcon>library_books</List.ItemIcon>
								Experience
							</List.LinkItem>
							<List.LinkItem onClick={() => { route('/education'); this.closeDrawer(); }}>
								<List.ItemIcon>school</List.ItemIcon>
								Education
							</List.LinkItem>
							<List.LinkItem onClick={() => { route('/events'); this.closeDrawer(); }}>
								<List.ItemIcon>public</List.ItemIcon>
